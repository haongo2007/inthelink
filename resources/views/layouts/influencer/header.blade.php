                                ...
                                <div id="mySidenav" class="sidenav">
                                    ...
                                    <nav>
                                        ...
                                        <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                            <li><a href="{{ route('influencer.home') }}">{{ __('Main') }}</a></li>
                                            <li>
                                            ...
                                            <li><a href="{{ route('influencer.favorite') }}">{{ __('Wishlist') }}</a></li>
                                            <li><a href="{{ route('influencer.dashboard') }}">{{ __('Dashboard') }}</a></li>
                                        </ul>
                                    </nav>
                                </div>
                        </div>
