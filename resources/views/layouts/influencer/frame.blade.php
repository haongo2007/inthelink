...
<head>
    ...
    {{-- style css --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('css') }}/influencer.style.css" media="screen" id="color">
...
<body>
    ...
    @include('layouts.influencer.header')
    @yield('content')
    @include('layouts.influencer.footer')
    @include('layouts.influencer.modal')
