...
<div class="page-main-header">
    <div class="main-header-right row">
        ...
        <div class="main-header-center d-lg-none">
            <div class="logo-wrapper">
                <h1 class="logobrand-sm">Inthelink</h1>
            </div>
        </div>
        <div class="nav-right col">
            <ul class="nav-menus">
                ...
                -->
                <li class="onhover-dropdown">
                    <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{ Auth('supplier')->user()->GetAvatar->path }}" alt="header-user">
                        <div class="dotted-animation"><span class="animate-circle"></span><span class="main-circle"></span></div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                        <li><a href="{{ route('supplier.settings') }}"><i data-feather="user"></i>Edit Profile</a></li>
                        <li><a href="#"><i data-feather="mail"></i>Inbox</a></li>
                        <li><a href="#"><i data-feather="lock"></i>Lock Screen</a></li>
                        <li><a href="#"><i data-feather="settings"></i>Settings</a></li>
                        @if (Auth('supplier')->user())
                            <li><a href="#" onclick="event.preventDefault();document.getElementById('logout-supplier').submit();">
                            <i data-feather="log-out"></i> {{ __('Logout') }}</a></li>
